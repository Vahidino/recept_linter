...
def main():
    ...
    config_path = "C:\\Users\\User\\Desktop\\recept-reengeder\\config.json"
    ...
    eu_validated = accuall_correction.ounces_to_grams(file, ounces_to_grams)
    ...
    with open(output_file, 'w') as fil: # skriver till outputfilen
